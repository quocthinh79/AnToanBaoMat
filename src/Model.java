...
public class Model {
    ...
    public static List<Character> space = List.of(' ');
    public static List<Character> generalAlphabetListWithSpace = new ArrayList<>(Stream.concat(generalAlphabetList.stream(), space.stream()).toList());
